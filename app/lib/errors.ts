...
import {
  ...
  KADENCE_ERROR__INVALID_BONUS_AMOUNT,
  KADENCE_ERROR__CHALLENGE_BONUS_EXCEEDS_MAX,
  type KadenceError,
...
const KADENCE_ERROR_CODES: Record<number, KadenceError> = {
  ...
  [KADENCE_ERROR__INVALID_BONUS_AMOUNT]: KADENCE_ERROR__INVALID_BONUS_AMOUNT,
  [KADENCE_ERROR__CHALLENGE_BONUS_EXCEEDS_MAX]: KADENCE_ERROR__CHALLENGE_BONUS_EXCEEDS_MAX,
};
