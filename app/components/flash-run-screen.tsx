...
function EventCard({
  ...
  const countdown = useCountdown(
    status === "upcoming" ? event.windowStart : event.windowEnd
  );
    ...
    >
      ...
      >
        ...
        <div style={{ position: "relative" }}>
              ...
              {status !== "past" &&
                (isBoost ? (
                  ...
                  >
                    ...
                    <span
                      style={{ fontSize: 9, color: "rgba(224,244,121,0.55)" }}
                    >
                      KAD
                    </span>
                  </div>
                  ...
                  >
                    {event.prizePoolKad.toLocaleString()}{" "}
                    <span
                      style={{ fontSize: 9, color: "rgba(224,244,121,0.55)" }}
                    >
                      KAD
          ...
          <div
            style={{
              fontSize: isLive ? 30 : 19,
              fontWeight: 700,
              letterSpacing: "-0.02em",
              lineHeight: 1,
              marginTop: isLive ? 16 : 10,
            }}
          >
            {event.name}
          </div>
          ...
          >
            {isBoost ? (
              event.distanceM > 0 && (
                ...
                >
                  <KIcon name="route" size={13} color="#E0F479" /> min {distKm}{" "}
                  km
                </span>
              )
            ) : (
              <>
                ...
                >
                  <KIcon name="users" size={13} color="#E0F479" />{" "}
            ...
            <span
              style={{
                marginLeft: "auto",
                color: isPast ? "rgba(255,255,255,0.3)" : "#E0F479",
                fontWeight: 700,
                fontSize: 11,
                textTransform: "uppercase",
                letterSpacing: "0.1em",
      ...
      >
        ...
        <div>
          ...
          <input
            ...
            value={prizePoolKad}
            onChange={(e) =>
              setPrizePoolKad(Math.max(0, Number(e.target.value)))
            }
            style={{
              width: "100%",
              background: "rgba(255,255,255,0.06)",
        ...
        >
          <KIcon name="zap" size={18} color="#0D0D0D" fill="#0D0D0D" /> Launch
          event
        </KButton>
      </div>
    </div>
      ...
      >
        <div
          style={{
            ...
            inset: 0,
            background:
              "radial-gradient(ellipse at 80% 10%, rgba(224,244,121,0.18) 0%, transparent 55%)",
          }}
        />
        ...
        <div style={{ position: "relative" }}>
          ...
          >
            Flash
            <br />
            <span style={{ color: "#E0F479" }}>Runs.</span>
          </h1>
          <div
            style={{
              fontSize: 13,
          ...
          >
            Boosts multiply your KAD. Races have prize pools — compete for the
            podium.
          </div>
        </div>
      </div>
        ...
        {tabs.map((t) => (
          <button
            ...
            style={{
              ...
              border:
                filter === t.key ? "none" : "1px solid rgba(255,255,255,0.12)",
              fontSize: 12,
              fontWeight: 700,
              fontFamily: "var(--font-sans)",
              cursor: "pointer",
    ...
    >
      <div style={{ width: 24, display: "flex", justifyContent: "center" }}>
        {position <= 3 ? (
          ...
          <span
            style={{
              fontSize: 12,
              color: isYou ? "#E0F479" : "rgba(255,255,255,0.4)",
              fontWeight: 700,
      ...
      <span
        style={{
          fontSize: 13,
          fontVariantNumeric: "tabular-nums",
          color: isYou ? "#E0F479" : "rgba(255,255,255,0.55)",
          fontWeight: isYou ? 700 : 500,
        }}
      >
        {time}
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            <KIcon
              ...
              size={16}
              color={
                ["#E0F479", "rgba(255,255,255,0.6)", "rgba(224,244,121,0.5)"][i]
              }
            />
          ...
          >
            {Math.round(pool * t.pct)}{" "}
            <span style={{ fontSize: 9, color: "rgba(224,244,121,0.6)" }}>
              KAD
            </span>
          </div>
        </div>
...
function formatWindow(event: FlashRun): string {
  ...
  if (s.getHours() === 0 && e.getHours() === 23 && e.getMinutes() === 59)
    return "All day";
  const fmt = (d: Date) => {
    const h = d.getHours();
...
function DetailView({
  ...
  const { joinedIds, results, joinEvent, resetResult, deleteEvent } =
    useFlashRun();
    ...
    >
      ...
      <div style={{ position: "relative", height: 260, overflow: "hidden" }}>
        ...
        <div
          style={{
            ...
            inset: 0,
            background:
              "radial-gradient(ellipse at 60% 40%, rgba(224,244,121,0.15) 0%, transparent 40%)",
        ...
        >
          <g stroke="rgba(224,244,121,0.1)" strokeWidth="1" fill="none">
            {[60, 110, 160, 210].map((r, i) => (
              <circle key={i} cx="207" cy="220" r={r} />
            ))}
          </g>
        </svg>
          ...
          <div>
                ...
                >
                  <span
                    style={{
                      ...
                      borderRadius: "50%",
                      background: "#0D0D0D",
                      animation: "kadPulse 1.2s infinite",
                    }}
                  />
                  Live now
                </span>
            ...
            >
              {event.name.split(" ").length > 2 ? (
                ...
                <>
                  {event.name.replace(/\s+(\S+)$/, " ")}
                  <span style={{ color: "#E0F479" }}>
      ...
      >
            ...
            {[
              {
                icon: "zap" as const,
                label: "Multiplier",
                value: `${event.boostMultiplier}×`,
                accent: true,
              },
              {
                icon: "route" as const,
                label: "Min distance",
                value: event.distanceM > 0 ? `${distKm} km` : "Any",
              },
              {
                icon: "timer" as const,
                label: "Window",
                value: formatWindow(event),
              },
            ].map((s, i) => (
              <div
                key={i}
          ...
          >
            {[
              ...
              },
              {
                ...
                label: "Prize pool",
                value: `${event.prizePoolKad.toLocaleString()} KAD`,
                accent: true,
              },
              {
                icon: "users" as const,
                label: "Runners",
                value: String(event.participantCount + (isJoined ? 1 : 0)),
              },
            ].map((s, i) => (
              <div
                key={i}
        ...
        {isBoost && (
          <div
            style={{
              ...
              border: "1px solid rgba(224,244,121,0.15)",
              borderRadius: 16,
            }}
          >
            ...
            >
              Run during this window to earn {event.boostMultiplier}× KAD on
              your base reward.
              {event.distanceM > 0 &&
                ` Minimum ${(event.distanceM / 1000).toFixed(0)} km to qualify.`}
        ...
        {!isBoost && status === "past" && myResult && (
          ...
          >
            ...
            <div style={{ display: "flex", alignItems: "baseline", gap: 10 }}>
              <span style={{ fontSize: 32, fontWeight: 700, color: "#E0F479" }}>
                {positionSuffix(myResult.position)}
              </span>
              <span style={{ fontSize: 14, color: "rgba(255,255,255,0.5)" }}>
                of {myResult.totalParticipants} runners
              </span>
            </div>
            <div
              style={{
          ...
          (status === "upcoming" ? (
            ...
            <div>
              ...
              >
                ...
                {isJoined && !myResult && competitors.length > 0 && (
                  <LeaderRow
        ...
        {!isBoost && status === "live" && !isJoined && (
          ...
          >
            <KIcon name="zap" size={18} color="#0D0D0D" fill="#0D0D0D" /> Join
            race
          </KButton>
        )}
        {!isBoost && status === "live" && isJoined && !myResult && (
          <KButton
            size="lg"
            style={{ width: "100%" }}
            onClick={() => onStartRace(event)}
          >
            <KIcon name="play" size={16} color="#0D0D0D" fill="#0D0D0D" /> Start
            race
          </KButton>
        )}
        ...
        {!isBoost && status === "upcoming" && isJoined && (
          <div
            style={{
              textAlign: "center",
              padding: 14,
              background: "rgba(224,244,121,0.08)",
              border: "1px solid rgba(224,244,121,0.2)",
              borderRadius: 14,
              fontSize: 13,
              color: "rgba(224,244,121,0.7)",
        ...
        {!isBoost && status === "live" && myResult && (
          <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
            ...
            >
              ...
              <span style={{ fontSize: 13, color: "#3FB977", fontWeight: 700 }}>
        ...
        {isBoost && status === "live" && (
          ...
          >
            Boost active — start a run from home to earn {event.boostMultiplier}
            × KAD
          </div>
        )}
...
export function RacePodium({
  ...
  const playerRow: Row = {
    position,
    name: "You",
    time: formatFinishTime(durationSec),
    isYou: true,
  };
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
      ...
      >
        ...
        <div
          style={{ fontSize: 14, color: "rgba(255,255,255,0.5)", marginTop: 6 }}
        >
