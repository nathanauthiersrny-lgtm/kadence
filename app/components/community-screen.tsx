...
function typeIcon(
  type: Community["type"]
): Parameters<typeof KIcon>[0]["name"] {
  ...
  return (
    ...
    >
      ...
      >
        {joined ? (
          <>
            <KIcon name="check" size={14} color="#3FB977" /> Joined
          </>
        ) : (
          "Join Community"
        )}
...
function BrowseView({ onJoined }: { onJoined: () => void }) {
  ...
  const filtered =
    activeType === "all"
      ? communities
      : communities.filter((c) => c.type === activeType);
      ...
      {runCount < 3 ? (
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <div>
              ...
              >
                Auto-match unlocks after {3 - runCount} more run
                {3 - runCount !== 1 ? "s" : ""}
              </div>
              <div
                style={{
              ...
              >
                We&apos;ll suggest your community based on your pace &amp;
                distance.
              </div>
            </div>
          </div>
            ...
            {[0, 1, 2].map((i) => (
              <div
                ...
                style={{
                  ...
                  borderRadius: 50,
                  background:
                    i < runCount ? "#E0F479" : "rgba(255,255,255,0.1)",
                  boxShadow:
                    i < runCount ? "0 0 6px rgba(224,244,121,0.4)" : "none",
                }}
              />
            ))}
          </div>
        ...
        >
          ...
          <span style={{ fontSize: 12, color: "rgba(255,255,255,0.7)" }}>
            ...
            <strong style={{ color: "#E0F479" }}>
              {tierLabel(suggestedTier)}
            </strong>{" "}
            tier.
          </span>
        </div>
        ...
        {(["all", "road", "trail"] as const).map((t) => (
          <button
            ...
            style={{
              ...
              border: "1px solid",
              borderColor:
                activeType === t ? "#E0F479" : "rgba(255,255,255,0.12)",
              background:
                activeType === t ? "rgba(224,244,121,0.12)" : "transparent",
...
function DetailView({
  ...
  const { sharedRuns, fireRun, hasFired } = useSocialFeed(
    joinedCommunity?.id ?? null
  );
  ...
  const handleClaim = useCallback(async () => {
    ...
    try {
      ...
      void mutateBalance();
      toast.success(
        `+${joinedCommunity.challenge.bonusKad} KAD challenge bonus!`,
        {
          description: sig ? (
            <a
      ...
      >
        <div
          style={{
            ...
            inset: 0,
            background:
              "radial-gradient(ellipse at 85% 30%, rgba(63,185,119,0.25) 0%, transparent 60%), linear-gradient(180deg, rgba(224,244,121,0.06) 0%, transparent 100%)",
          }}
        />
        <div
          style={{
            ...
            inset: 0,
            background:
              "radial-gradient(ellipse at 85% 30%, rgba(63,185,119,0.15) 0%, transparent 50%)",
          ...
          >
            <div
              style={{
                ...
                height: 44,
                borderRadius: 14,
                background: "linear-gradient(135deg, #E0F479, #3FB977)",
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
              }}
            ...
            <div style={{ flex: 1 }}>
              <div style={{ fontSize: 13, color: "rgba(255,255,255,0.7)" }}>
                {tierLabel(c.tier)} ·{" "}
                {c.type.charAt(0).toUpperCase() + c.type.slice(1)} focus
              </div>
            </div>
            <span
              style={{
      ...
      >
        ...
        <div
          style={{
            ...
            borderRadius: 18,
            background:
              "linear-gradient(135deg, rgba(224,244,121,0.12) 0%, rgba(63,185,119,0.06) 100%)",
            border: "1px solid rgba(224,244,121,0.3)",
          }}
        >
          <div
          ...
          >
            <div
              style={{
                ...
                borderRadius: 4,
                boxShadow:
                  progressPct >= 100 ? "0 0 8px rgba(224,244,121,0.4)" : "none",
          ...
          >
            ...
            <span style={{ color: "#E0F479", fontWeight: 700 }}>
        ...
        >
          {[
            {
              value: String(weekProgress.myRunCount),
              label: "Runs this week",
              accent: false,
            },
            {
              value: fmtKm(weekProgress.myKm),
              label: "Km this week",
              accent: true,
            },
          ].map((s, i) => (
                  ...
                  >
                    ...
                    <div
                      style={{
                        ...
                        alignItems: "center",
                        gap: 6,
                        marginBottom: run.routeCoords.length >= 2 ? 10 : 0,
                      }}
                    >
