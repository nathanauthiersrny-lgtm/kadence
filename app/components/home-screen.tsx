...
export function HomeScreen({
  ...
  const { data: kadBalance, isLoading: kadLoading } = useKadBalance(address);
  const { level, levelTitle } = useXP();
  const { streak, multiplier } = useStreak();
  const { quest, progressKm, completed, timeUntilReset } = useQuests();
  const { joinedCommunity, weekProgress, collectiveKm, challengeComplete } =
    useCommunity();
      ...
      <div style={{ position: "relative", height: 380, overflow: "hidden" }}>
        ...
        <div
          style={{
            ...
            inset: 0,
            background:
              "radial-gradient(ellipse at 30% 20%, rgba(224,244,121,0.2) 0%, transparent 40%)",
        ...
        <div style={{ position: "absolute", left: 22, right: 22, bottom: 22 }}>
          ...
          >
            ...
            the
            <br />
            <span style={{ color: "#E0F479" }}>distance.</span>
          </div>
          <div
            style={{
              fontSize: 13,
        ...
        {status === "connected" && !completed && progressKm > 0 && (
          <KCard padding={14}>
            ...
            >
              ...
              <span style={{ fontSize: 10, color: "#E0F479", fontWeight: 700 }}>
            ...
            <div
              style={{
                ...
                background: hasLive
                  ...
                  : "#1A1A1A",
                border: hasLive
                  ? "1px solid rgba(224,244,121,0.3)"
            ...
            >
              ...
              >
                <span
                  style={{
                    fontSize: 11,
                    color: hasLive ? "#E0F479" : "rgba(255,255,255,0.4)",
                    fontWeight: 700,
                    textTransform: "uppercase",
                    letterSpacing: "0.1em",
                  }}
                      ...
                      style={{
                        width: `${Math.min(
                          joinedCommunity.challenge.type === "collective_km"
                            ? (collectiveKm /
                                joinedCommunity.challenge.target) *
                                100
